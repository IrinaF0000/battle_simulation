...
Open the static viewer directly from the repository or through GitHub Pages:

```text
docs/replay-viewer/index.html
```

The viewer includes a prepared demo trace and also supports loading any compatible `trace.json` file manually.
